  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conexiones estratégicas en recursos humanos y evaluación organizacional
        p.mb-4 Relacionar de manera precisa los conceptos fundamentales en la gestión del recurso humano, la evaluación del desempeño y la eficacia organizacional.
